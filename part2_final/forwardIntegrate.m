...
% Created: 31 Oct 2021
    ...
    while t_total < TOTAL_TIME 
        ...
        [Utemp, FLAG_terminate] = ROB535_ControlProject_part2_Team26(TestTrack,Xobs_seen,curr_state); %%
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%             
%             hold on
%             plot(Ytemp(:,1),Ytemp(:,3),'g','linewidth',1.5);
            % update the counter
    ...
    getTrajectoryInfo(Y,U,Xobs,t_update)
